module Day08.Input exposing (parsedInput, Input, Instruction)
...
parseInstruction string =
    case String.words string of
        [ register, o, v, "if", compRegister, cf, cv ] ->
            case ( parseOp o, parseValue v, parseValue cv, parseFunc cf ) of
                ( Just op, Just value, Just compValue, Just compFunc ) ->
                    Just <| Instruction register op value compRegister compValue compFunc
